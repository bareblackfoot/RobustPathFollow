...
parser.add_argument('--GRU-size', default=64, type=int)
...
parser.add_argument('--memory-dim', default=128, type=int)
...
parser.add_argument('--test-step', default=5000, type=int)
parser.add_argument('--print-step', default=20, type=int)
parser.add_argument('--is-training', default=True, type=bool)
